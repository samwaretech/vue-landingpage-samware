    ...
    <section style="background-color:#ec0f72;">
      <div class="twhite center container" style="padding:80px 0px">
        ...
        <div class="card shadows left tgraym">
          <span style="color:#ec0f72">Apakah Saya bisa Mengcustom permintaan?</span>
          <ul>
            <li>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Natus quos amet commodi debitis deserunt, fugiat qui, obcaecati voluptatem quisquam eligendi vel nostrum suscipit repudiandae possimus nisi tempora, tenetur dolorem porro.</li>
          </ul>
        </div>
        <div class="card shadows left tgraym">
          <span style="color:#ec0f72">Apakah Saya bisa Mengcustom permintaan?</span>
